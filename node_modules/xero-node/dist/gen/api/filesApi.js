...
class FilesApi {
     ...
     */
    createFileAssociation(xeroTenantId, fileId, association, idempotencyKey, options = { headers: {} }) {
     ...
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */
    createFolder(xeroTenantId, folder, idempotencyKey, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */
    updateFile(xeroTenantId, fileId, fileObject, idempotencyKey, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/Files/{FileId}'
                .replace('{' + 'FileId' + '}', encodeURIComponent(String(fileId)));
            let localVarQueryParameters = {};
